...
class FeedbackController extends BackendBaseController
{
    ...
    protected function listAjaxIteration()
    {
        return function (FeedbackModel $item) {
            ...
            $item->vip_level_text = MemberModel::USER_VIP_TYPE[$item->vip_level]??'';
            $item->reply = '';
...
//            }
    ...
    public function setstatusAction()
    {
        ...
        $uid = FeedbackModel::where('id', $id)->value('uid');
    ...
    public function recoveryuserAction()
    {
        ...
        $snapShot = MemberSnapshotModel::where('uid', $uid)->where('created_at','>','2023-01-22')->first();
        if (is_null($snapShot)) {
