...
class MemberaifreeController extends BackendBaseController
{
    ...
    {
        return function (MemberAiFreeModel $item) {
            return $item;
        };
    }
    ...
    {
        return MemberAiFreeModel::class;
    }
    ...
    public function addLotteryTimesAction(){
        try {
            ...
            MemberAiFreeModel::setRecord($member->aff, $val);
