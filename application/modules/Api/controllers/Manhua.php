...
class ManhuaController extends BaseController
{
    ...
    public function indexAction()
    {
        ...
        $return['icon'] = [
            [
                'name' => '连载',
                'icon' => url_ads('/new/xiao/20220610/2022061020141996542.png'),
                'type' => 'doing',
                'key'  => 'type',
            ],
            [
                'name' => '完结',
                'icon' => url_ads('/new/xiao/20220610/2022061020142395158.png'),
                'type' => 'finish',
                'key'  => 'type',
            ],
            [
                'name' => '短篇',
                'icon' => url_ads('/new/xiao/20220610/2022061020115447519.png'),
                'type' => 'short',
                'key'  => 'type',
            ],
            [
    ...
    public function detailAction()
    {
        $id = $this->post['id'] ?? 0;
        try {
            $data = ManhuaService::getDetailData($id);
            $this->showJson($data);
