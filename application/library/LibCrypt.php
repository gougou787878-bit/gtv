...
class LibCrypt
{
    ...
    public static function socketMsg($main, $sub, $info)
    {
        $object = new self();
        $encryptKey = 'ljhlksslgkjfhlksuo8472rju6p2od03';
        $appKey = 'kihfks3kjdhfksjh3kdjfs745dkslfh4';
        $object->setKey($appKey, $encryptKey);
        $returnData = [
            'main' => $main,
            'sub'  => $sub,
            'info' => $info
        ];
        return $object->replyData($returnData);
    }
