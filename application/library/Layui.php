...
HTML;
    ...
    public static function uploadPos($imgColumn, $inputColumn, $width = "100", $height = "50", $position = null,$inputType = 'hidden')
    {
        $dataJson = [];
        if (!empty($position)) {
            $dataJson = ['position' => $position];
        }
        return self::uploadEle($imgColumn, $inputColumn, $width, $height, $dataJson,$inputType);
    }
