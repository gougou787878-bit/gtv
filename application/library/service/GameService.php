...
class GameService
{
    ...
    private static $apiUrl = 'http://google.com/';
    private static $channel = 'xx';
    const  SIGN_KEY = '12';
    const  ENCRYPT_KEY = '12';
     ...
     * @return string
     */
    public function enterGame($uid, $id)
    {
        $data = [
            'mod'  => 'game',
            'code' => 'index',
    ...
    static function gameProductList()
    {
        ...
        return array_map(function ($item) {
            $rs = [
                ...
                //'tips'        => '',//商品tips
                'gift_type'   => '1',//赠送类型  1 vip 2 观影券  默认 0
                'gift_number' => $item >= 1000 ? '7' : '0',//赠送类型对应的礼物数量  默认 0
