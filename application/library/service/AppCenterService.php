...
class AppCenterService
{
    ...
    const API_APP = 'https://ug.hao123apps.info/api.php/api/ads/appCenter';//应用中心
    const API_ADS = 'https://ug.hao123apps.info/api.php/api/ads/ads';//相关广告
    ...
    const PRODUCT_ID = 27;//当前产品联盟中心-编号
    const PRODUCT_GOLD_ID = 27;//砖石产品编号
    const POS_START = 'polo-start';//定义广告位
