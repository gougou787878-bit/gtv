...
class FileUploadService
{
    ...
    const UPLOADMP4URL = 'http://examine.xmyy8.co/uploadMp4.php';//<100M
    //const UPLOADMP4URL = 'http://video.ycomesc.com:2082/uploadMp4.php';
    //const UPLOADMP4URL = 'http://mp4.ycomesc.com/uploadMp4.php';//大文件
    const UPLOADMP4_KEY = 'e096db7c006958f226bc469c27237b65';
    ...
    static function doUploadAndQiePian($file)
    {
        ...
        try {
            $uuid = self::XF_UUID;
            $updateData = CurlService::uploadMp42Remote($uuid, $file, self::UPLOADMP4URL);
            echo "respon \r\n";
            print_r($updateData);
