...
class AppFeedSystemService
{
    //https://app.polomv.com/index.php?m=feedsync&a=index
    ...
    protected function sendRemoteRequest($url, $postData = [], $timeout = 30)
    {
        ...
        try {
            ...
            //print_r('remote:'.var_export([$result],1));
    ...
    {
        $data['app'] = SYSTEM_ID;
        return $this->sendRemoteRequest(self::API_APP, $data);
    }
