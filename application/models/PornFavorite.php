 ...
 * @mixin \Eloquent
 */
class PornFavoriteModel extends EloquentModel
{
    protected $table = "porn_favorites";
    ...
    const PORN_GAME_FAVORITE_SET = 'porn:game:favorite:set:%d';
