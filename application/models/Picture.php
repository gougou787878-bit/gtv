...
class PictureModel extends EloquentModel
{
    ...
    public function getIsLikeAttribute()
    {
        ...
        if (empty($this->watchUser) || !$this->getAttributeValue('id')) {
            return 0;
        }
        ...
        return PictureFavoritesModel::hasLike($this->watchUser->getAttributeValue('uid'), $this->getAttributeValue('id')) ? 1 : 0;
    }
    ...
    public function getIsPayAttribute()
    {
        ...
        return PicturePayModel::hasBuy($this->watchUser->getAttributeValue('uid'), $this->getAttributeValue('id')) ? 1 : 0;
    }
