...
class MhModel extends EloquentModel
{
    ...
    public function getIsLikeAttribute()
    {
        ...
        return MhFavoritesModel::hasLike($this->watchUser->getAttributeValue('uid'),
    ...
    public function getIsPayAttribute()
    {
        ...
        return MhPayModel::hasBuy($this->watchUser->getAttributeValue('uid'), $this->getAttributeValue('id')) ? 1 : 0;
    }
        ...
        if ($thumb = $this->attributes['thumb']) {
            if (!$this->from) {
                ...
                if (strcasecmp($moduleName , 'admin') === 0){
                    return 'https://img.elodm.com/'.$thumb;
                }
            }
