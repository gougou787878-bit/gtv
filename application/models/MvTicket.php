 ...
 * @property int $mv_id 
 * @property int $mv_uid 
 * @property int $used_style 0 mv 1 av
 *
 * @author xiongba
 * @date 2021-04-16 11:05:27
 *
 * @mixin \Eloquent
 */
class MvTicketModel extends Model
{
    ...
    protected $fillable = ['uid', 'status', 'expired_at', 'name', 'add_at', 'used_at', 'mv_id', 'mv_uid', 'used_style'];
