...
class CartoonCategoryModel extends EloquentModel
{
    ...
    const CK_CARTOON_LIST_SEARCH = 'redis:cartoon:category:list:search';
    const GP_CARTOON_LIST_SEARCH = 'redis:cartoon:category:list:search:group';
    const CN_CARTOON_LIST_SEARCH = '动漫分类搜索';
                ...
                return self::queryBase()
                    ...
                    ->map(function (self $item) {
                        ...
                        return [
                            ...
                            'more_api'      => '/api/cartoon/search_cate',
    ...
    {
        $data = cached(self::CK_CARTOON_LIST_SEARCH)
            ->group(self::GP_CARTOON_LIST_SEARCH)
            ->chinese(self::CN_CARTOON_LIST_SEARCH)
            ->fetchPhp(function () {
                return self::queryBase()
                    ->get()
                    ->map(function (self $item) {
