...
class FindReplyMvModel extends Model
{
    ...
    const FIND_REPLY_MV_LIST_BYUUID = 'find:reply:mv:list:uuid:%s:%d:%d';
     ...
     * @return mixed
     */
    public static function getMvListByUuid($uuid, $page, $limit){
        $key = sprintf(self::FIND_REPLY_MV_LIST_BYUUID, $uuid, $page, $limit);
        return cached($key)
            ->group(self::FIND_REPLY_MV_LIST_GROUP)
